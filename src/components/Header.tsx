                ...
                >
                    {NAV_LINKS.map(({ href, icon: Icon, label }) => (
                        <Link
                            key={label}
                            href={href}
                            className="flex items-center gap-2 rounded px-2 py-1 hover:text-coral transition-colors focus-visible:ring-2 focus-visible:ring-coral"
                        >
                    ...
                    <button
                        type="button"
                        className="flex items-center gap-1 hover:text-coral transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral rounded px-2 py-1 cursor-pointer"
                        aria-label="Select currency and region. Current: India, INR"
                    >
                        <span
                            className="text-xs border border-white/30 rounded px-1.5 py-0.5 mr-1"
                            aria-hidden="true"
                        >
                            IN
                        </span>
