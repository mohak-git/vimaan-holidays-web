...
export default function SpecialFares({ selected, onSelect }: Props) {
    return (
        <div className="flex flex-wrap items-center px-2 gap-2 font-bold">
            <span className="text-xs text-ink/60 uppercase tracking-wider">Special Fares:</span>
                            ...
                            <button
                                ...
                                className={`text-xs px-3 py-1 rounded-sm border transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-coral ${
                                    isActive
                                        ...
                                        : "border-black/30 text-ink/70 hover:border-black/20"
                                }`}
                            >
                                {fare}
                            </button>
